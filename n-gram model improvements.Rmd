...
#en_us_blogs[,data:=unnest_tokens(en_us_blogs,data,data,token="lines",format="text")]
en_us_blogs[,data:=iconv(data,"latin1","ASCII",sub="")]
en_us_blogs[,data:=str_replace_all(data, "[^a-zA-Z ]", "")]
en_us_blogs[,data:=str_trim(data, "both")]
en_us_blogs[data!=""]
en_us_blogs[!is.na(data)]
en_us_blogs[lengths(strsplit(data," "))>1]

setnames(en_us_news,"en_us_news","data",skip_absent=TRUE)
#en_us_news[,data:=unnest_tokens(en_us_news,data,data,token="lines",format="text")]
en_us_news[,data:=iconv(data,"latin1","ASCII",sub="")]
en_us_news[,data:=str_replace_all(data, "[^a-zA-Z ]", "")]
en_us_news[,data:=str_trim(data, "both")]
en_us_news[data!=""]
en_us_news[!is.na(data)]
en_us_news[lengths(strsplit(data," "))>1]

setnames(en_us_twitter,"en_us_twitter","data",skip_absent=TRUE)
#en_us_twitter[,data:=unnest_tokens(en_us_twitter,data,data,token="lines",format="text")]
en_us_twitter[,data:=iconv(data,"latin1","ASCII",sub="")]
en_us_twitter[,data:=str_replace_all(data, "[^a-zA-Z ]", "")]
en_us_twitter[,data:=str_trim(data, "both")]
en_us_twitter[data!=""]
en_us_twitter[!is.na(data)]
en_us_twitter[lengths(strsplit(data," "))>1]
...
```{r ngrams_dt}
capstone_unigrams <- capstone[unnest_tokens(capstone,word1,data,token = "ngrams",n=1, collapse=FALSE)]
